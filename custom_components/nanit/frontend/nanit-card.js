...
`;let bt=class extends at{setConfig(t){this._config={...t}}_entityChanged(t){const e=t.detail.value;if(!this._config||e===this._config.camera_entity_id)return;const i={...this._config,camera_entity_id:e};this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:i}}))}render(){return this.hass&&this._config?B`
      <div class="editor">
        <ha-entity-picker
          .hass=${this.hass}
  ...
  `,t([pt({attribute:!1})],bt.prototype,"hass",void 0),t([ut()],bt.prototype,"_config",void 0),bt=t([lt("nanit-card-editor")],bt);let ft=class extends at{static getConfigElement(){return document.createElement("nanit-card-editor")}static getStubConfig(t){const e=Object.keys(t.states).find(e=>e.startsWith("camera.")&&"nanit"===t.entities[e]?.platform);return{type:"custom:nanit-card",camera_entity_id:e||""}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t}getCardSize(){return 5}_entities(){return this._config?.camera_entity_id&&this.hass?function(t,e){const i={};i.camera=e;const s=t.entities[e];if(s?.device_id){const e=s.device_id,r=[];for(const i of Object.keys(t.entities))t.entities[i].device_id===e&&"diagnostic"!==t.entities[i].entity_category&&r.push(i);gt(i,r,t)}else{const s=e.split(".")[1]??"";gt(i,Object.keys(t.states).filter(t=>t!==e&&t.split(".")[1]?.startsWith(s.split("_camera")[0]||s)),t)}return i}(this.hass,this._config.camera_entity_id):{}}_isCameraOn(t){return!t.power||"on"===this.hass.states[t.power]?.state}_fireMoreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}_toggleService(t,e,i){this.hass.callService(t,e,{entity_id:i})}render(){if(!this.hass||!this._config)return B`<ha-card><div class="header"><span class="device-name">Nanit</span></div></ha-card>`;const t=this._entities(),e=this._isCameraOn(t),i=t.camera?function(t,e){const i=t.states[e];return i?(i.attributes.friendly_name??"Nanit").replace(/ Camera$/i,""):"Nanit"}(this.hass,t.camera):"Nanit";return B`
    ...
    `}_renderSensorOverlays(t){const e=[];if(mt(this.hass,t.temperature)){const i=parseFloat(this.hass.states[t.temperature].state),s=isNaN(i)?this.hass.states[t.temperature].state:i.toFixed(1),r=this.hass.states[t.temperature].attributes.unit_of_measurement??"";e.push(B`
        <div class="pill pill-temp" @click=${()=>this._fireMoreInfo(t.temperature)}>
          <ha-icon icon="mdi:thermometer"></ha-icon>
          <span>${s}${r}</span>
        </div>
      `)}if(mt(this.hass,t.humidity)){const i=parseFloat(this.hass.states[t.humidity].state),s=isNaN(i)?this.hass.states[t.humidity].state:i.toFixed(1);e.push(B`
        <div class="pill pill-humid" @click=${()=>this._fireMoreInfo(t.humidity)}>
          <ha-icon icon="mdi:water-percent"></ha-icon>
          <span>${s}%</span>
        </div>
      `)}if(mt(this.hass,t.light)){const i=parseFloat(this.hass.states[t.light].state),s=isNaN(i)?this.hass.states[t.light].state:Math.round(i).toString();e.push(B`
    ...
    `}_renderSoundMachine(t){const e=this.hass.states[t],i="playing"===e?.state,s=e?.attributes.source??"",r=e?.attributes.source_list??[],n=e?.attributes.volume_level??0,o=Math.round(100*n);return B`
      <div class="control-section control-section-sound">
        ...
        <div class="control-row">
          ...
          <div class="slider-row">
            <div class="nanit-slider" style="--slider-pct: ${o}%">
              <input
                type="range"
                min="0"
                max="100"
