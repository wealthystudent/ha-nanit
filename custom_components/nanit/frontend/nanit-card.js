    ...
    `}_renderStream(t){const e=t.camera?this.hass.states[t.camera]:void 0;return D`
      <div class="stream-wrap">
        ${e?D`
              ...
              >
                ${_t(`${t.camera}-${this._streamEpoch}`,D`
                  <ha-camera-stream
                    muted
