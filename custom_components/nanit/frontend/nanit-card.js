...
`;let yt=class extends ot{setConfig(t){this._config={...t}}_entityChanged(t,e){const i=e.detail.value||void 0;this._config&&i!==this._config[t]&&this._updateConfig({[t]:i})}_toggleChanged(t,e){const i=e.target.checked;this._updateConfig({[t]:i})}_updateConfig(t){const e={...this._config,...t};for(const[i,s]of Object.entries(t))void 0===s&&delete e[i];this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:e}}))}render(){return this.hass&&this._config?F`
  ...
  `,t([pt({attribute:!1})],yt.prototype,"hass",void 0),t([ut()],yt.prototype,"_config",void 0),yt=t([lt("nanit-card-editor")],yt);const wt=6e4,$t="video, img, canvas, ha-hls-player, ha-web-rtc-player";let xt=class extends ot{constructor(){super(...arguments),this._streamLoaded=!1,this._streamPlayerMounted=!1,this._showNetwork=!1,this._streamEpoch=0,this._lastVideoTime=0,this._sawProgress=!1,this._stallStrikes=0,this._startupStrikes=0,this._healthyTicks=0,this._reloadCount=0,this._reloadWindowStart=0,this._cooldownUntil=0,this._streamMountedAt=0,this._watchedEpoch=-1,this._recoveringStream=!1,this._resumeRecoverUntil=0,this._backendRecoveryInFlight=!1,this._recoverStreamOnResume=()=>{if(document.hidden)return;const t=this._entities();if(!this._isCameraOn(t))return;if(!this.renderRoot.querySelector("ha-camera-stream"))return;const e=Date.now();e<this._resumeRecoverUntil||(this._resumeRecoverUntil=e+wt,this._startupStrikes=0,this._stallStrikes=0,this._healthyTicks=0,this._checkStreamLiveness())}}static getConfigElement(){return document.createElement("nanit-card-editor")}static getStubConfig(t){const e=Object.keys(t.states).find(e=>e.startsWith("camera.")&&"nanit"===t.entities[e]?.platform);return{type:"custom:nanit-card",camera_entity_id:e||""}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config=t}getCardSize(){return 5}_entities(){return this._config?.camera_entity_id&&this.hass?function(t,e){const i={};i.camera=e;const s=t.entities[e];if(s?.device_id){const e=s.device_id,r=[],a=[];for(const i of Object.keys(t.entities))t.entities[i].device_id===e&&("diagnostic"===t.entities[i].entity_category?a.push(i):r.push(i));vt(i,r,t),function(t,e,i){for(const s of e){const[e]=s.split(".",1),r=s.split(".")[1]??"",a=i.states[s]?.attributes.device_class;"sensor"===e&&("signal_strength"===a?t.wifi_signal=s:"frequency"===a?t.wifi_frequency=s:r.endsWith("_wifi_ssid")&&(t.wifi_ssid=s))}}(i,a,t)}else{const s=e.split(".")[1]??"";vt(i,Object.keys(t.states).filter(t=>t!==e&&t.split(".")[1]?.startsWith(s.split("_camera")[0]||s)),t)}return i}(this.hass,this._config.camera_entity_id):{}}_isCameraOn(t){return!t.power||"off"!==this.hass.states[t.power]?.state}_fireMoreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}_toggleService(t,e,i){this.hass.callService(t,e,{entity_id:i})}connectedCallback(){super.connectedCallback(),document.addEventListener("visibilitychange",this._recoverStreamOnResume),window.addEventListener("pageshow",this._recoverStreamOnResume)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("visibilitychange",this._recoverStreamOnResume),window.removeEventListener("pageshow",this._recoverStreamOnResume),this._clearStreamWatchdog(),this._clearBackendRecoveryFallback()}updated(t){super.updated(t);this.renderRoot.querySelector("ha-camera-stream")?(this._watchedEpoch!==this._streamEpoch&&(this._watchedEpoch=this._streamEpoch,this._streamMountedAt=Date.now()),this._streamWatchdog||this._startStreamWatchdog()):this._clearStreamWatchdog()}_startStreamWatchdog(){this._streamWatchdog=setInterval(()=>this._checkStreamLiveness(),1e3),this._checkStreamLiveness()}_clearStreamWatchdog(){this._streamWatchdog&&(clearInterval(this._streamWatchdog),this._streamWatchdog=void 0)}_hasVisualStreamElement(t){const e=t.shadowRoot;if(!e)return!1;if(e.querySelector($t))return!0;for(const t of Array.from(e.querySelectorAll("*")))if(t.shadowRoot?.querySelector($t))return!0;return!1}_findStreamVideo(t){const e=t.shadowRoot;if(!e)return null;const i=e.querySelector("video");if(i)return i;const s=e.querySelector("ha-hls-player, ha-web-rtc-player"),r=s?.shadowRoot?.querySelector("video");if(r)return r;for(const t of Array.from(e.querySelectorAll("*"))){const e=t.shadowRoot?.querySelector("video");if(e)return e}return null}_checkStreamLiveness(){const t=this.renderRoot.querySelector("ha-camera-stream");if(!t)return;this._streamPlayerMounted=this._hasVisualStreamElement(t);const e=this._findStreamVideo(t);return!this._streamLoaded&&this._streamMountedAt>0&&Date.now()-this._streamMountedAt>3500&&(this._streamPlayerMounted=!0),e?(!this._streamLoaded&&e.readyState>=2&&(this._streamLoaded=!0,this._streamPlayerMounted=!0,this._clearBackendRecoveryFallback()),e.readyState<2?(this._startupStrikes+=1,void(this._startupStrikes>=15&&this._recoverStream())):e.currentTime>this._lastVideoTime+.05?(this._lastVideoTime=e.currentTime,this._sawProgress=!0,this._stallStrikes=0,this._startupStrikes=0,this._streamLoaded=!0,this._streamPlayerMounted=!0,this._clearBackendRecoveryFallback(),void(!e.paused&&++this._healthyTicks>=10&&(this._reloadCount=0,this._cooldownUntil=0,this._reloadWindowStart=0))):(this._healthyTicks=0,void(this._sawProgress&&!e.paused&&(this._stallStrikes+=1,this._stallStrikes>=8&&this._recoverStream())))):(this._startupStrikes+=1,void(this._startupStrikes>=15&&this._recoverStream()))}_requestBackendStreamReset(){const t=this._entities();return t.camera?this.hass.callService("nanit","reset_stream",{entity_id:t.camera}):Promise.resolve()}_clearBackendRecoveryFallback(){void 0!==this._backendRecoveryFallback&&(window.clearTimeout(this._backendRecoveryFallback),this._backendRecoveryFallback=void 0)}_scheduleBackendRecoveryFallback(){this._clearBackendRecoveryFallback(),this._backendRecoveryFallback=window.setTimeout(()=>{this._backendRecoveryFallback=void 0,this._streamLoaded||this._backendRecoveryInFlight||(this._backendRecoveryInFlight=!0,this._requestBackendStreamReset().catch(()=>{}).finally(()=>{this._backendRecoveryInFlight=!1,this._reloadStream()}))},1e4)}async _recoverStream(){if(!this._recoveringStream){this._recoveringStream=!0;try{this._reloadStream(),this._scheduleBackendRecoveryFallback()}finally{this._recoveringStream=!1}}}_reloadStream(){const t=Date.now();t<this._cooldownUntil?this._stallStrikes=0:(t-this._reloadWindowStart>wt&&(this._reloadWindowStart=t,this._reloadCount=0),this._reloadCount+=1,this._reloadCount>=3&&(this._cooldownUntil=t+wt),this._streamEpoch+=1,this._streamLoaded=!1,this._lastVideoTime=0,this._sawProgress=!1,this._stallStrikes=0,this._startupStrikes=0,this._healthyTicks=0)}_onStreamLoad(){this._streamPlayerMounted=!0}_resetStreamState(){this._streamLoaded=!1,this._streamPlayerMounted=!1,this._clearStreamWatchdog(),this._clearBackendRecoveryFallback(),this._lastVideoTime=0,this._sawProgress=!1,this._stallStrikes=0,this._startupStrikes=0,this._healthyTicks=0,this._reloadWindowStart=0,this._resumeRecoverUntil=0,this._streamMountedAt=0,this._watchedEpoch=-1}render(){if(!this.hass||!this._config)return F`<ha-card><div class="header"><span class="device-name">Nanit</span></div></ha-card>`;const t=this._entities(),e=this._isCameraOn(t);e||this._resetStreamState();const i=t.camera?function(t,e){const i=t.states[e];return i?(i.attributes.friendly_name??"Nanit").replace(/ Camera$/i,""):"Nanit"}(this.hass,t.camera):"Nanit";return F`
      <ha-card>
    ...
    `}_renderHeader(t,e,i){const s=!this._config.hide_connectivity_status&&(bt(this.hass,e.wifi_ssid)||bt(this.hass,e.wifi_signal)||bt(this.hass,e.wifi_frequency)),r=!this._config.hide_baby_name,a=e.power&&!this._config.hide_power_button;return r||!i||s||a?F`
      <div class="header">
        ${r?F`
            ...
            `:B}
        ${i?B:F`<span class="camera-off-label">Camera Off</span>`}
    ...
    `:F``}_renderNetworkPopup(t){const e=t.wifi_ssid?this.hass.states[t.wifi_ssid]?.state:void 0,i=t.wifi_signal?this.hass.states[t.wifi_signal]?.state:void 0,s=t.wifi_signal?this.hass.states[t.wifi_signal]?.attributes.unit_of_measurement??"dBm":"dBm",r=t.wifi_frequency?this.hass.states[t.wifi_frequency]?.state:void 0,a=t.wifi_frequency?this.hass.states[t.wifi_frequency]?.attributes.unit_of_measurement??"MHz":"MHz",n=i?parseInt(i,10):-100;let o="Weak",c="#e74c3c";return n>=-50?(o="Excellent",c="#2ecc71"):n>=-60?(o="Good",c="var(--nanit-teal)"):n>=-70&&(o="Fair",c="var(--nanit-amber)"),F`
    ...
    `}_renderStream(t){const e=t.camera?this.hass.states[t.camera]:void 0;return F`
      <div class="stream-wrap">
        ${e?F`
              ...
              >
                ${_t(`${t.camera}-${this._streamEpoch}`,F`
                  <ha-camera-stream
                    muted
              ...
              <div class="stream-loader ${this._streamLoaded?"hidden":this._streamPlayerMounted?"connecting":""}">
                <div class="loader-content">
                  ...
                  ${this._streamPlayerMounted?F`<span class="loader-label">Connecting video…</span>`:F`<div class="loader-spinner"></div>`}
                </div>
              </div>
            `:F`
              <div
    ...
    `}_renderSensorOverlays(t){const e=[],i=this._config.temperature_entity_id||t.temperature,s=this._config.humidity_entity_id||t.humidity;if(bt(this.hass,i)){const t=parseFloat(this.hass.states[i].state),s=isNaN(t)?this.hass.states[i].state:t.toFixed(1),r=this.hass.states[i].attributes.unit_of_measurement??"";e.push(F`
        <div class="pill pill-temp" @click=${()=>this._fireMoreInfo(i)}>
          <ha-icon icon="mdi:thermometer"></ha-icon>
          <span>${s}${r}</span>
        </div>
      `)}if(bt(this.hass,s)){const t=parseFloat(this.hass.states[s].state),i=isNaN(t)?this.hass.states[s].state:t.toFixed(1),r=this.hass.states[s].attributes.unit_of_measurement??"%";e.push(F`
        <div class="pill pill-humid" @click=${()=>this._fireMoreInfo(s)}>
          <ha-icon icon="mdi:water-percent"></ha-icon>
          <span>${i}${r}</span>
        </div>
      `)}return 0===e.length?F``:F`<div class="overlay-top">${e}</div>`}_renderDetectionOverlays(t){const e=bt(this.hass,t.motion),i=bt(this.hass,t.sound);if(!e&&!i)return F``;const s=e&&"on"===this.hass.states[t.motion].state,r=i&&"on"===this.hass.states[t.sound].state;return F`
    ...
    `}_renderControls(t){const e=!this._config.hide_night_light&&bt(this.hass,t.night_light),i=!this._config.hide_sound_machine&&bt(this.hass,t.sound_machine);return e||i?F`
      <div class="controls">
        ${e?this._renderNightLight(t.night_light):B}
        ${i?this._renderSoundMachine(t.sound_machine):B}
      </div>
    `:F``}_renderNightLight(t){const e=this.hass.states[t],i="on"===e?.state,s=e?.attributes.brightness??0,r=Math.round(s/255*100);return F`
    ...
    `}_renderSoundMachine(t){const e=this.hass.states[t],i="playing"===e?.state,s=e?.attributes.source??"",r=e?.attributes.source_list??[],a=e?.attributes.volume_level??0,n=Math.round(100*a);return F`
      <div class="control-section control-section-sound">
        ...
        <div class="control-row">
          ...
          ${i?F`<span class="track-name">${this._formatSourceName(s)}</span>`:B}
          <div class="slider-row">
    ...
    `}_sourceIcon(t){return{white_noise:"mdi:sine-wave",birds:"mdi:bird",waves:"mdi:waves",wind:"mdi:weather-windy",rain:"mdi:weather-rainy",water_stream:"mdi:water",fan:"mdi:fan",heartbeat:"mdi:heart-pulse",dryer:"mdi:tumble-dryer",vacuum:"mdi:robot-vacuum"}[t.replace(/\.wav$/i,"").toLowerCase()]??"mdi:music-note"}_formatSourceName(t){return t.replace(/\.wav$/i,"").replace(/_/g," ")}};xt.styles=ft,t([pt({attribute:!1})],xt.prototype,"hass",void 0),t([ut()],xt.prototype,"_config",void 0),t([ut()],xt.prototype,"_streamLoaded",void 0),t([ut()],xt.prototype,"_streamPlayerMounted",void 0),t([ut()],xt.prototype,"_showNetwork",void 0),t([ut()],xt.prototype,"_streamEpoch",void 0),xt=t([lt("nanit-card")],xt),window.customCards=window.customCards||[],window.customCards.push({type:"nanit-card",name:"Nanit Camera",description:"Camera stream with controls for Nanit baby cameras",preview:!0});export{xt as NanitCard};
